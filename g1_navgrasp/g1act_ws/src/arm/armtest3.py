...
class Custom:
    def __init__(self):
        ...
        self.transition_time = 1.5       # 动作1：抬臂时间
        self.hold_time = 10.0             # 动作1：保持时间
        self.release_time = 1.5          # 释放时间
        ...
        self.left_target_pos = {
            G1JointIndex.LeftShoulderPitch: -0.6,   # 向前抬起
            G1JointIndex.LeftShoulderRoll:  0.5,    # 稍微外展
            G1JointIndex.LeftShoulderYaw:   -0.2,    # 轻微内旋
            G1JointIndex.LeftElbow:         -0.2,   # 伸直手臂
            G1JointIndex.LeftWristRoll:     0.2,   # 手掌朝内
        }
    ...
    def LowCmdWrite(self):
        ...
        # 阶段3：柔顺释放（回到初始位置）
            ...
            # 所有关节柔顺释放
            all_joints = self.left_arm_joints + self.right_arm_joints + self.waist_joints
